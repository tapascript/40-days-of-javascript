...
export class ExpenseUI {
    ...
    bindEvents() {
        ...
        this.elements.addExpenseForm.addEventListener('submit', (e) => this.handleAddExpense(e));
        this.elements.simplifyBtn.addEventListener('click', () => this.handleSimplify());
        ...
        importBtn.className = 'bg-blue-500 text-white px-4 py-2 rounded ml-2';
        importBtn.addEventListener('click', () => {
            this.elements.importFile.click();
        });
        this.elements.exportBtn.parentNode.appendChild(importBtn);
    }
